...
class HandSwappingTest(RobotArmController):
    ...
    def _setup_scene(self):
        ...
        self.scene.add_entity(
            gs.morphs.URDF(
                file = 'genesis/SwappingStation/urdf/SwappingStationURDF.urdf',
                pos = (1.30, 0.6, 1.60),
    ...
    def move_arm_ready(self):
        right_xy = np.array([-0.45, -0.25, 0.75])
        left_xy = np.array([0.45, -0.25, 0.75])
...
if __name__ == "__main__":
    controller = HandSwappingTest(
        urdf_file="genesis/SwappingURDF/urdf/SwappingURDF.urdf",
        ee_name="wrist_right",
